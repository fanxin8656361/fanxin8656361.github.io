<template>
  <div class="main">
    ...
    <div class="nav-tabs">
      ...
      <a
        href="https://www.iconfont.cn/manage/index?manage_type=myprojects&projectId=3617074"
        target="_blank"
        class="nav-more"
        rel="noopener norefferrer"
        >查看项目</a
      ...
      <div class="content unicode" style="display: block">
        ...
        <div class="article markdown">
          ...
          <pre><code class="language-css">
            ...
            src: url('iconfont.woff2?t=1661765018970') format('woff2'),
                url('iconfont.woff?t=1661765018970') format('woff'),
                url('iconfont.ttf?t=1661765018970') format('truetype');
  }
  </code></pre>
  ...
  >&lt;span class="iconfont"&gt;&amp;#x33;&lt;/span&gt;
      ...
      <div class="content font-class">
        <ul class="icon_lists dib-box">
          ...
          <li class="dib">
            <span class="icon iconfont icon-a-Fill12"></span>
            <div class="name">Fill 12</div>
            <div class="code-name">.icon-a-Fill12</div>
          </li>
      ...
      <div class="content symbol">
        <ul class="icon_lists dib-box">
          ...
          <li class="dib">
            <svg class="icon svg-icon" aria-hidden="true">
              <use xlink:href="#icon-a-Fill12"></use>
            </svg>
            <div class="name">Fill 12</div>
            <div class="code-name">#icon-a-Fill12</div>
          </li>
...
<script>
// @import "./iconfont.js";
// import "https://a1.alicdn.com/oss/uploads/2018/12/26/7bfddb60-08e8-11e9-9b04-53e73bb6408b.js";
// import "https://a1.alicdn.com/oss/uploads/2018/12/26/a3f714d0-08e6-11e9-8a15-ebf944d7534c.js"; <!-- 代码高亮 -->
export default {
...
@import "https://g.alicdn.com/thx/cube/1.3.2/cube.min.css";
@import "./demo.css";
@import "./iconfont.css";
